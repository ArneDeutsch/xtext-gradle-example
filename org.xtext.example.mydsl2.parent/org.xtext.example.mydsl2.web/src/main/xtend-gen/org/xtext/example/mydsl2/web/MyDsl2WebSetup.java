...
import org.xtext.example.mydsl2.web.MyDsl2WebModule;

/**
 * Initialization support for running Xtext languages in web applications.
 */
@SuppressWarnings("all")
public class MyDsl2WebSetup extends MyDsl2StandaloneSetup {
  @Override
  public Injector createInjector() {
    ...
    MyDsl2WebModule _myDsl2WebModule = new MyDsl2WebModule();
    return Guice.createInjector(Modules2.mixin(_myDsl2RuntimeModule, _myDsl2IdeModule, _myDsl2WebModule));
  }
}
