...
import org.xtext.example.mydsl2.web.MyDsl2WebSetup;
...
public class MyDsl2Servlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new MyDsl2WebSetup().createInjectorAndDoEMFRegistration();
